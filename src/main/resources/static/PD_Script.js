    ...
    groups: [
        {
            ...
            series: [
                { code: '0301', title: 'Miscellaneous Administration and Program', positions: ['Program Analyst', 'Administrative Specialist', 'Program Support Specialist'] },
                { code: '0343', title: 'Management and Program Analysis', positions: ['Management Analyst', 'Program Analyst', 'Operations Analyst'] },
                { code: '0346', title: 'Logistics Management', positions: ['Logistics Management Specialist', 'Supply Program Analyst', 'Distribution Manager'] }
            ]
        },
        {
            code: '0800',
            ...
            series: [
                ...
                { code: '0810', title: 'Civil Engineering', positions: ['Civil Engineer', 'Structural Engineer', 'Geotechnical Engineer'] },
                { code: '0855', title: 'Electronics Engineering', positions: ['Electronics Engineer', 'RF Engineer', 'Avionics Engineer'] }
            ]
        },
        {
            code: '2200',
            ...
            series: [
                { code: '2210', title: 'Information Technology Management', positions: ['IT Specialist (SYSADMIN)', 'IT Specialist (INFOSEC)', 'IT Project Manager'] }
            ]
        }
    ]
};
